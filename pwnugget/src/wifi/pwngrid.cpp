...
void initPwngrid() {
    // Set up Pwngrid configuration.
    wifi_promiscuous_filter_t pwngrid_filter = {
        .filter_mask = WIFI_PROMIS_FILTER_MASK_MGMT | WIFI_PROMIS_FILTER_MASK_DATA
    };
    esp_wifi_set_promiscuous_filter(&pwngrid_filter);
    esp_wifi_set_promiscuous_rx_cb(&pwnSnifferCallback);
    esp_wifi_set_promiscuous(true);

    // Set random channel for Pwngrid.
